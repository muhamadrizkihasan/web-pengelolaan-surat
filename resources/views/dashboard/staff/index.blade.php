...
@section('users')
    <h1>Data Staff Tata Usaha</h1>
    <p><a href="{{ route('dashboard') }}">Home</a> / <a href="{{ route('staff.index') }}">Data Staff Tata Usaha</a></p>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex">
                        ...
                        <a href="{{ route('staff.create') }}" class="btn btn-primary btn-round justify-content-start ml-3">
                            <i class="fa fa-plus"> </i>
                            Tambah Data
                        </a>
                        <form action="{{ route('staff.search') }}" class="ml-auto justify-content-end">
                                    ...
                                    @foreach ($users as $user)
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-center">
                                                <a href="{{ route('staff.edit', $user['id']) }}"class="btn btn-xs btn-primary mr-2"><i class="fa fa-edit"> Edit</i></a>
