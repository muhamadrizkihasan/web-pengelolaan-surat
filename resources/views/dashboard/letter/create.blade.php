...
@section('users')
    ...
    <p><a href="{{ route('dashboard') }}">Home</a> / <a href="{{ route('letter.index') }}">Data Surat</a> / <a href="{{ route('letter.create') }}">Tambah Data Surat</a></p>
    <div class="card">
        <div class="card-body">
            <form action="{{ route('letter.store') }}" class="card p-4 mt-5 d-flex" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="mb-3 mx-1">
                            ...
                            <input type="text" name="letter_perihal" id="letter_perihal" class="form-control">
                            @error('email')
                        ...
                        <tr>
                                ...
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="{{ $user->id }}" name="recipients[]">
                                    </div>
                                </td>
                            @endforeach
                        </tr>
