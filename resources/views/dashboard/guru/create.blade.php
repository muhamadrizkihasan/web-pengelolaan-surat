...
@section('users')
    ...
    <p><a href="{{ route('dashboard') }}">Home</a> / <a href="{{ route('guru.index') }}">Data Guru</a> / <a href="{{ route('guru.create') }}">Tambah Data Guru</a></p>

    <div class="container-fluid">
        <form action="{{ route('guru.store') }}" class="card p-4" method="POST">
            @csrf
